...
2. Jalankan: python3 mike_v02_core.py
3. memory_store.txt akan simpan semua data penting dan boleh diubah secara manual.
4. Bila restart, skrip akan baca balik fail tersebut dan sambung identity/objective Mike.
